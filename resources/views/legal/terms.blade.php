    ...
    <main class="text-custom-gray flex flex-grow">
        <div class="container px-4 sm:px-6 md:px-8 lg:px-24 py-3 sm:py-4 md:py-5 mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 sm:p-8 md:p-10 prose prose-sm sm:prose max-w-none">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第2条（利用登録）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第3条（ユーザーIDおよびパスワードの管理）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第4条（利用料金）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                    本サービスは無料でご利用いただけます。ただし、通信にかかる費用はユーザーの負担とします。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第5条（禁止事項）</h2>
                <p class="text-sm sm:text-base leading-relaxed mb-2">ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第6条（本サービスの提供の停止等）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第7条（利用制限および登録抹消）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第8条（退会）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                    ユーザーは，当サービスの定める退会手続により，本サービスから退会できるものとします。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第9条（保証の否認および免責事項）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第10条（サービス内容の変更等）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                    当サービスは，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第11条（利用規約の変更）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第12条（個人情報の取扱い）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                    当サービスは，本サービスの利用によって取得する個人情報については，当サービス「プライバシーポリシー」に従い適切に取り扱うものとします。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第13条（通知または連絡）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第14条（権利義務の譲渡の禁止）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
