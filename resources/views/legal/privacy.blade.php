<x-app-layout>
    ...
    <main class="text-custom-gray flex flex-grow">
        <div class="container px-4 sm:px-6 md:px-8 lg:px-24 py-3 sm:py-4 md:py-5 mx-auto">
            <!-- タイトル -->
            <h1 class="text-2xl sm:text-3xl md:text-h1 2xl:text-5xl font-bold text-center mb-8 py-6 md:py-8 indent-[0.2em] lg:indent-[0.5em] tracking-[0.2em] lg:tracking-[0.5em]">プライバシーポリシー</h1>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 sm:p-8 md:p-10 prose prose-sm sm:prose max-w-none">
                <p class="text-sm sm:text-base leading-relaxed mb-6">
                    ワクワク宝集め（以下，「当サービス」といいます。）は，本ウェブサイト上で提供するサービス（以下，「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第1条（個人情報）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                    「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，メールアドレスその他の記述等により特定の個人を識別できる情報を指します。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第2条（個人情報の収集方法）</h2>
                <p class="text-sm sm:text-base leading-relaxed">
                    当サービスは，ユーザーが利用登録をする際に氏名，メールアドレス，パスワードなどの個人情報をお尋ねすることがあります。
                </p>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第3条（個人情報を収集・利用する目的）</h2>
                <p class="text-sm sm:text-base leading-relaxed mb-2">当サービスが個人情報を収集・利用する目的は，以下のとおりです。</p>
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第4条（利用目的の変更）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第5条（個人情報の第三者提供）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第6条（個人情報の開示）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第7条（個人情報の訂正および削除）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第8条（個人情報の利用停止等）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                ...
                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第9条（プライバシーポリシーの変更）</h2>
                <ol class="list-decimal list-inside space-y-2 text-sm sm:text-base leading-relaxed">
                    <li>本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。</li>
                    <li>当サービスが別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
                </ol>

                <h2 class="text-lg sm:text-xl font-bold mt-8 mb-4">第10条（お問い合わせ窓口）</h2>
                <p class="text-sm sm:text-base leading-relaxed mb-4">
                    本ポリシーに関するお問い合わせは，<a href="{{ route('contact') }}" class="text-blue-600 hover:underline font-semibold">お問い合わせフォーム</a>よりお願いいたします。
                </p>
            </div>
        </div>
    </main>
