        ...
        <main class="text-custom-gray flex flex-grow">
            <div class="container px-24 py-5 mx-auto">
                ...
                <!-- タブ部分 -->
                    ...
                    <!-- タスク表示部分 -->
                    <div data-panel="0" class="js-tab-panel1 flex flex-col justify-between bg-white border-custom-gray text-center h-[60vh] border-2 overflow-y-auto">
                    ...
                    <div data-panel="1" class="js-tab-panel1 hidden flex flex-col justify-between bg-white border-custom-gray text-center h-[60vh] border-2 overflow-y-auto">
                        <ul class="list-disc px-20 mt-5">
                            @for ($i = 0; $i < 5; $i++)
                                <div class="flex justify-between py-3">
                                    <li class="tracking-[0.5em]">
